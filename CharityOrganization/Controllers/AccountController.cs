...
namespace CharityOrganization.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Register([Bind(Include = "CustomerID,FirstName,LastName,Gender,EmailAddress,VerifyEmailAddress,PhoneNumber,CurrentAddress,CreatePassword,VerifyPassword")] CreateAccount createAccount)
        {
            if (ModelState.IsValid)
            {
                ...
                var user = new ApplicationUser { UserName = createAccount.LastName, Email = createAccount.EmailAddress };
                var result = await UserManager.CreateAsync(user, createAccount.CreatePassword);
                if (result.Succeeded)
                {
